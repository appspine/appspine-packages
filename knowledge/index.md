# Knowledge Index - appspine-workspace

| 文件編號 / 檔名 | 類型 | 狀態 | 標題與摘要 |
| --- | --- | --- | --- |
| [001-app-framework-plan.md](topics/001-app-framework-plan.md) | topic | active | 001 - 業務系統開發框架 - 基本框架規劃 |
...
| [040-oidc-audience-azp-hardening-plan.md](decisions/040-oidc-audience-azp-hardening-plan.md) | decision | completed | 040 - OIDC Token 跨 App 重放缺口修復（`azp` 驗證強化）- 系統設計計畫 |
| [041-shared-notification-capability-plan.md](decisions/041-shared-notification-capability-plan.md) | decision | active | 041 - Shared Notification Capability 正式實作計畫 |
...
| [051-pl2-04-plugin-lockfile.md](topics/051-pl2-04-plugin-lockfile.md) | topic | active | 051 PL2-04 — `appspine.plugin-lock.json` |
...
| [051-pl3-02-frontend-generator.md](topics/051-pl3-02-frontend-generator.md) | topic | active | 051 PL3-02 — Next.js build-time generator |
| [051-pl3-03-identity-core-frontend.md](topics/051-pl3-03-identity-core-frontend.md) | topic | active | 051 PL3-03 — 遷移 Users Admin 到 `identity-core/frontend` |
| [051-pl3-04-oidc-auth-frontend.md](topics/051-pl3-04-oidc-auth-frontend.md) | topic | active | 051 PL3-04 — 遷移 OIDC Login 到 `oidc-auth/frontend` |
...
| [051-pl3-10-independent-security-review.md](topics/051-pl3-10-independent-security-review.md) | topic | active | 051 PL3-10 — 獨立安全審查（Claude，獨立於 Gemini 之外執行） |
...
| [051-pl4-09-governance-audit.md](topics/051-pl4-09-governance-audit.md) | topic | active | 051 PL4-09 — Package Coverage & Governance Audit 審計報告 |
...
| [051-pl5-03-template-canary-plugin-mode.md](topics/051-pl5-03-template-canary-plugin-mode.md) | topic | active | 051 PL5-03 — App Template 切換至 Canary Plugin Mode 報告 |
...
| [Z04-template-backend-start-entrypoint.md](decisions/Z04-template-backend-start-entrypoint.md) | decision | active | Z04 - Template Backend Start Entrypoint |
| [Z05-template-common-singleton-override.md](decisions/Z05-template-common-singleton-override.md) | decision | active | Z05 - Template Common Package Singleton Override |
| [Z06-template-scaffold-port-flags.md](decisions/Z06-template-scaffold-port-flags.md) | decision | active | Z06 - Template scaffold port flags |
| [Z07-common-version-cascade-gap.md](decisions/Z07-common-version-cascade-gap.md) | decision | active | Z07 - `@appspine/common` internal-dependency cascade gap |
| [Z08-mcp-tool-decorator-ctx-drop.md](decisions/Z08-mcp-tool-decorator-ctx-drop.md) | decision | active | Z08 - `registerMcpToolsFromInstance()` dropped `McpCallContext` |
| [Z09-biome-parameter-decorators.md](decisions/Z09-biome-parameter-decorators.md) | decision | active | Z09 - Template `biome.json` missing `unsafeParameterDecoratorsEnabled` |
| [Z10-mcp-server-transitive-version-mismatch.md](decisions/Z10-mcp-server-transitive-version-mismatch.md) | decision | active | Z10 - `@appspine/mcp-server` transitive dependency version mismatch |
| [Z11-cross-app-workflow-exploration.md](decisions/Z11-cross-app-workflow-exploration.md) | decision | archived | Z11 - 對外介接層架構初探（記錄，未定案） |
| [Z13-cross-app-enum-doc-comment-gap.md](decisions/Z13-cross-app-enum-doc-comment-gap.md) | decision | active | Z13 - 跨 App Prisma Enum 缺少 `///` 文件註解（已修復，防再犯機制已實作） |
| [Z20-domain-events-outbox.md](topics/Z20-domain-events-outbox.md) | topic | superseded | Z20 - Domain Events and Transaction-bound Outbox |
| [Z21-shared-package-release-infra-gaps.md](topics/Z21-shared-package-release-infra-gaps.md) | topic | active | Z21 - 共用套件發布基礎設施缺口（025 執行期間意外發現） |
| [Z22-release-pipeline-approval-gate-and-build-order.md](decisions/Z22-release-pipeline-approval-gate-and-build-order.md) | decision | active | Z22 - Release pipeline：卡住的核准關卡、CI 建置順序 bug，與新增的健康檢查機制 |
| [Z24-blindspot-review-20260724.md](decisions/Z24-blindspot-review-20260724.md) | decision | active | Z24 - appspine Blindspot Review（PM/架構師視角，unknown unknowns 盤點） |
| [Z25-ticket-agent-workflow-concept.md](decisions/Z25-ticket-agent-workflow-concept.md) | decision | active | Z25 - Ticket 化 Agent 工作流構想（聊天建立需求 → 核准 → Agent 執行 → 自動佈署 → 通知結案） |
| [Z27-oidc-migration-post-completion-review.md](decisions/Z27-oidc-migration-post-completion-review.md) | decision | active | Z27 - 035 OIDC-only Auth 遷移：事後多 Agent 安全審查與修復 |
| [Z30-mcp-auth-migration-feasibility.md](topics/Z30-mcp-auth-migration-feasibility.md) | topic | paused | Z30 - MCP 認證機制遷移可行性研究（未來計畫，已擱置） |
| [Z31-document-governance-workflow-plan.md](topics/Z31-document-governance-workflow-plan.md) | topic | active | Z31 - 知識庫文件治理流程計劃 |
